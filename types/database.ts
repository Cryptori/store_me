...
export type Database = {
  public: {
    Tables: {
      ...
      payments: {
        Row: {
          id: string; store_id: string; midtrans_order_id: string
          midtrans_transaction_id: string | null; midtrans_token: string | null
          amount: number; durasi_bulan: number; payment_type: string | null
